...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'keyboard_to_ackermann_drive = f1tenth_stack.keyboard_to_ackermann_drive:main',
            'listen_scan = f1tenth_stack.listen_scan:main',
            'agent_node = f1tenth_stack.agent_node:main'
        ],
    },
)
